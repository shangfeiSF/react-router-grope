...
describe('createRoutesFromReactChildren', function () {
  ...
  it('works with index routes', function () {
    var routes = (0, _RouteUtils.createRoutesFromReactChildren)(_react2.default.createElement(
      _Route2.default,
      { path: '/', component: Parent },
      _react2.default.createElement(_IndexRoute2.default, { component: Hello })
    ));

    (0, _expect2.default)(routes).toEqual([{
      path: '/',
      component: Parent,
      indexRoute: {
        component: Hello
  ...
  it('works with falsy children', function () {
    var routes = (0, _RouteUtils.createRoutesFromReactChildren)([_react2.default.createElement(_Route2.default, { path: '/one', component: Parent }), null, _react2.default.createElement(_Route2.default, { path: '/two', component: Parent }), undefined]);
