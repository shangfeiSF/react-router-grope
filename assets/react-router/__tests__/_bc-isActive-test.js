    ...
    describe('with no query', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home')).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a query that also matches', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query' })).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a query that also matches by value, but not by type', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query', n: 2, show: false })).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a query that does not match', function () {
      it('is not active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { something: 'else' })).toBe(false);
          done();
        });
      });
    });
    ...
    describe('on the child', function () {
      it('is active for the child and the parent', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parent/child')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/parent/child', null, true)).toBe(true);
          (0, _expect2.default)(this.history.isActive('/parent')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/parent', null, true)).toBe(false);
          done();
        });
      });
      ...
      it('is not active with extraneous slashes', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parent////child////')).toBe(false);
          done();
        });
      });
      ...
      it('is not active with missing slashes', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parentchild')).toBe(false);
          done();
        });
      });
    });
    ...
    describe('on the parent', function () {
      it('is active for the parent', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parent/child')).toBe(false);
          (0, _expect2.default)(this.history.isActive('/parent/child', null, true)).toBe(false);
          (0, _expect2.default)(this.history.isActive('/parent')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/parent', null, true)).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with no query', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/home', null, true)).toBe(false);
          done();
        });
      });
    });
    ...
    describe('with a query that also matches', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query' })).toBe(true);
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query' }, true)).toBe(false);
          done();
        });
      });
    });
    ...
    describe('with a query that does not match', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { something: 'else' })).toBe(false);
          (0, _expect2.default)(this.history.isActive('/home', { something: 'else' }, true)).toBe(false);
          done();
        });
      });
    });
    ...
    describe('with no query', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/absolute')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/absolute', null, true)).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with no query', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', null)).toBe(true);
          (0, _expect2.default)(this.history.isActive('/home', null, true)).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a query that also matches', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query' })).toBe(true);
          (0, _expect2.default)(this.history.isActive('/home', { the: 'query' }, true)).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a nested index route', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parent/child', null)).toBe(true);
          (0, _expect2.default)(this.history.isActive('/parent/child', null, true)).toBe(true);
          done();
        });
      });
      ...
      it('is not active with extraneous slashes', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/parent///child///', null)).toBe(false);
          (0, _expect2.default)(this.history.isActive('/parent///child///', null, true)).toBe(false);
          done();
        });
      });
  ...
  describe('a pathname that matches only the beginning of the URL', function () {
    it('is not active', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        ...
        (0, _expect2.default)(this.history.isActive('/h')).toBe(false);
        done();
      });
    });
  });
  ...
  describe('a pathname that matches the root URL only if it is a parent route', function () {
    it('is active', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        ...
        (0, _expect2.default)(this.history.isActive('/')).toBe(true);
        done();
      });
    });
  });
  ...
  describe('a pathname that does not match the root URL if it is not a parent route', function () {
    it('is not active', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        ...
        (0, _expect2.default)(this.history.isActive('/')).toBe(false);
        done();
      });
    });
  });
  ...
  describe('a pathname that matches URL', function () {
    describe('with query that does match', function () {
      it('is active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { foo: ['bar', 'bar1', 'bar2'] })).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a custom parse function and a query that does not match', function () {
      it('is not active', function (done) {
        ...
        (0, _reactDom.render)(_react2.default.createElement(
          _Router2.default,
          { history: (0, _createMemoryHistory2.default)('/home?foo[1]=bar'), stringifyQuery: stringifyQuery, parseQueryString: parseQueryString },
          _react2.default.createElement(_Route2.default, { path: '/' }),
          _react2.default.createElement(_Route2.default, { path: '/home' })
        ), node, function () {
          (0, _expect2.default)(this.history.isActive('/home', { foo: { 4: 'bar' } })).toBe(false);
          done();
        });
      });
    });
    ...
    describe('with a custom parse function and a query that match', function () {
      it('is active', function (done) {
        ...
        (0, _reactDom.render)(_react2.default.createElement(
          _Router2.default,
          { history: (0, _createMemoryHistory2.default)('/home?foo[4]=bar&foo[1]=bar2'), stringifyQuery: stringifyQuery, parseQueryString: parseQueryString },
          _react2.default.createElement(_Route2.default, { path: '/' }),
          _react2.default.createElement(_Route2.default, { path: '/home' })
        ), node, function () {
          (0, _expect2.default)(this.history.isActive('/home', { foo: { 1: 'bar2', 4: 'bar' } })).toBe(true);
          done();
        });
      });
    });
    ...
    describe('with a query with explicit undefined values', function () {
      it('matches missing query keys', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { foo: 1, bar: undefined })).toBe(true);
          done();
        });
      });
      ...
      it('does not match a present query key', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(
          ...
          (0, _expect2.default)(this.history.isActive('/home', { foo: 1, bar: undefined })).toBe(false);
          done();
        });
      });
    });
    ...
    describe('when not on index route', function () {
      it('does not show index as active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/foo'), routes: routes }), node, function () {
          (0, _expect2.default)(this.history.isActive('/')).toBe(true);
          (0, _expect2.default)(this.history.isActive('/', null, true)).toBe(false);
          (0, _expect2.default)(this.history.isActive('/foo')).toBe(true);
          done();
        });
      });
    });
    ...
    describe('when on index route', function () {
      it('shows index as active', function (done) {
        (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/'), routes: routes }), node, function () {
          ...
          setTimeout(function () {
            (0, _expect2.default)(_this.history.isActive('/')).toBe(true);
            (0, _expect2.default)(_this.history.isActive('/', null, true)).toBe(true);
            (0, _expect2.default)(_this.history.isActive('/foo')).toBe(false);
            done();
          });
        });
      });
