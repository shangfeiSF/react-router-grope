...
describe('A <Redirect>', function () {
  ...
  it('works', function (done) {
    (0, _reactDom.render)(_react2.default.createElement(
      _Router2.default,
      { history: (0, _createMemoryHistory2.default)('/notes/5') },
  ...
  it('works with relative paths', function (done) {
    (0, _reactDom.render)(_react2.default.createElement(
      _Router2.default,
      { history: (0, _createMemoryHistory2.default)('/nested/route1') },
      ...
      (0, _expect2.default)(this.state.location.pathname).toEqual('/nested/route2');
      done();
    });
  });
  ...
  it('works with relative paths with param', function (done) {
    (0, _reactDom.render)(_react2.default.createElement(
      _Router2.default,
      { history: (0, _createMemoryHistory2.default)('/nested/1/route1') },
      _react2.default.createElement(
        _Route2.default,
        { path: 'nested/:id' },
        _react2.default.createElement(_Route2.default, { path: 'route2' }),
      ...
      (0, _expect2.default)(this.state.location.pathname).toEqual('/nested/1/route2');
      done();
    });
  });
});