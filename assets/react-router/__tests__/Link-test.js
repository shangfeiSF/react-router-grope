...
describe('A <Link>', function () {
  ...
  it('should not render unnecessary class=""', function () {
    (0, _reactDom.render)(_react2.default.createElement(_Link2.default, { to: '/something' }), node, function () {
      var a = node.querySelector('a');
      (0, _expect2.default)(a.hasAttribute('class')).toBe(false);
    });
  });
  ...
  it('knows how to make its href', function () {
    ...
    (0, _reactDom.render)(_react2.default.createElement(
      ...
      var a = node.querySelector('a');
      (0, _expect2.default)(a.getAttribute('href')).toEqual('/hello/michael?the=query#the-hash');
    });
  });
  ...
  describe('with params', function () {
    ...
    it('is active when its params match', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        _Router2.default,
        { history: (0, _createMemoryHistory2.default)('/hello/michael') },
        _react2.default.createElement(
          _Route2.default,
          { path: '/', component: App },
        ...
        (0, _expect2.default)(a.className.trim()).toEqual('active');
        done();
      });
    });
    ...
    it('is not active when its params do not match', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        ...
        (0, _expect2.default)(a.className.trim()).toEqual('');
        done();
      });
    });
    ...
    it('is active when its params and query match', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        _Router2.default,
        { history: (0, _createMemoryHistory2.default)('/hello/ryan?the=query') },
        _react2.default.createElement(
          _Route2.default,
          { path: '/', component: App },
          _react2.default.createElement(_Route2.default, { path: 'hello/:name', component: Hello })
    ...
    it('is not active when its query does not match', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(
        _Router2.default,
        { history: (0, _createMemoryHistory2.default)('/hello/ryan?the=other+query') },
        _react2.default.createElement(
          _Route2.default,
          { path: '/', component: App },
          _react2.default.createElement(_Route2.default, { path: 'hello/:name', component: Hello })
  ...
  describe('when its route is active and className is empty', function () {
    it("it shouldn't have an active class", function (done) {
      ...
      var history = (0, _createMemoryHistory2.default)('/goodbye');

      var a = void 0;
      var steps = [function () {
        a = node.querySelector('a');
        (0, _expect2.default)(a.className).toEqual('dontKillMe');
        history.push('/hello');
      }, function () {
        (0, _expect2.default)(a.className).toEqual('dontKillMe');
      }];
  ...
  describe('when its route is active', function () {
    it('has its activeClassName', function (done) {
      ...
      var steps = [function () {
        ...
        (0, _expect2.default)(a.className).toEqual('dontKillMe highlight');
      }];
    ...
    it('has its activeStyle', function (done) {
      ...
      var steps = [function () {
        a = node.querySelector('a');
        (0, _expect2.default)(a.style.color).toEqual('white');
        history.push('/hello');
      }, function () {
        (0, _expect2.default)(a.style.color).toEqual('red');
      }];
  ...
  describe('when route changes', function () {
    it('changes active state', function (done) {
      ...
      var steps = [function () {
        a = node.querySelector('a');
        (0, _expect2.default)(a.className).toEqual('');
        history.push('/hello');
      }, function () {
        (0, _expect2.default)(a.className).toEqual('active');
      }];
  ...
  describe('when clicked', function () {
    it('calls a user defined click handler', function (done) {
      var LinkWrapper = function (_Component9) {
        ...
        LinkWrapper.prototype.render = function render() {
          ...
          return _react2.default.createElement(
            _Link2.default,
            { to: '/hello', onClick: function onClick(e) {
    ...
    it('transitions to the correct route for string', function (done) {
      ...
      var spy = (0, _expect.spyOn)(history, 'push').andCallThrough();

      var steps = [function () {
        click(node.querySelector('a'), { button: 0 });
      }, function () {
        (0, _expect2.default)(node.innerHTML).toMatch(/Hello/);
        (0, _expect2.default)(spy).toHaveBeenCalled();

        var location = this.state.location;

        (0, _expect2.default)(location.pathname).toEqual('/hello');
        (0, _expect2.default)(location.search).toEqual('?the=query');
        (0, _expect2.default)(location.hash).toEqual('#hash');
      }];
    ...
    it('transitions to the correct route for object', function (done) {
      ...
      var steps = [function () {
        ...
        (0, _expect2.default)(location.pathname).toEqual('/hello');
        (0, _expect2.default)(location.search).toEqual('?how=are');
        (0, _expect2.default)(location.hash).toEqual('#world');
        (0, _expect2.default)(location.state).toEqual({ you: 'doing?' });
      }];
    ...
    it('does not transition when onClick prevents default', function (done) {
      ...
      var steps = [function () {
        ...
        (0, _expect2.default)(node.innerHTML).toMatch(/Link/);
