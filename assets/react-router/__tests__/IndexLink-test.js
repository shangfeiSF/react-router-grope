...
describe('An <IndexLink>', function () {
  ...
  describe('when linking to the root', function () {
    it('is active and other routes are not', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/'), routes: routes }), node, function () {
        (0, _expect2.default)(node.querySelector('#rootLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#overviewLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#contactLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsIndexLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#specificProductLink').className).toEqual('');
        done();
      });
    });
  });
  ...
  describe('when linking to the overview', function () {
    it('is active and other routes are not', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/website'), routes: routes }), node, function () {
        (0, _expect2.default)(node.querySelector('#rootLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#overviewLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#contactLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsIndexLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#specificProductLink').className).toEqual('');
  ...
  describe('when linking to the contact', function () {
    it('is active and other routes are not', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/website/contact'), routes: routes }), node, function () {
        (0, _expect2.default)(node.querySelector('#rootLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#overviewLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#contactLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#productsLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsIndexLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#specificProductLink').className).toEqual('');
        done();
  ...
  describe('when linking to the products', function () {
    it('is active and other routes are not', function (done) {
      (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/website/products'), routes: routes }), node, function () {
        (0, _expect2.default)(node.querySelector('#rootLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#overviewLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#contactLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#productsIndexLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#specificProductLink').className).toEqual('');
        done();
      });
    });
  ...
  describe('when linking to a specific product', function () {
    it("is active and it's parent is also active", function (done) {
      (0, _reactDom.render)(_react2.default.createElement(_Router2.default, { history: (0, _createMemoryHistory2.default)('/website/products/15'), routes: routes }), node, function () {
        (0, _expect2.default)(node.querySelector('#rootLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#overviewLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#contactLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#productsLink').className).toEqual('active');
        (0, _expect2.default)(node.querySelector('#productsIndexLink').className).toEqual('');
        (0, _expect2.default)(node.querySelector('#specificProductLink').className).toEqual('active');
        done();
      });
    });
  });
