...
describe('RouterContext', function () {
  var node = void 0,
      ...
      context = void 0,
      history = void 0,
      transitionManager = void 0,
      router = void 0;
  var listenBeforeLeavingRouteSentinel = void 0,
      isActiveSentinel = void 0,
      createHrefSentinel = void 0;
  ...
  beforeEach(function () {
    ...
    router = (0, _RouterUtils.createRouterObject)(history, transitionManager);
    ...
    var Component = function (_React$Component) {
      ...
      function Component(props, ctx) {
        ...
        var _this = _possibleConstructorReturn(this, _React$Component.call(this, props, ctx));
  ...
  afterEach(function () {
    return (0, _reactDom.unmountComponentAtNode)(node);
  });

  function renderTest(done) {
    (0, _match2.default)({ location: '/', routes: routes }, function (err, redirect, renderProps) {
      (0, _reactDom.render)(_react2.default.createElement(_RouterContext2.default, _extends({}, renderProps, { history: history, router: router })), node);
      done();
    });
  }
  ...
  it('exports a `router` object to routing context', function (done) {
    renderTest(function () {
      (0, _expect10.default)(context.router).toExist();
      done();
    });
  });
  ...
  describe('some weird tests that test implementation and should probably go away', function () {
    it('proxies calls to `push` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect = (0, _expect10.default)(history.push)).toHaveBeenCalledWith.apply(_expect, args);
        done();
      });
    });
    ...
    it('proxies calls to `replace` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect2 = (0, _expect10.default)(history.replace)).toHaveBeenCalledWith.apply(_expect2, args);
        done();
      });
    });
    ...
    it('proxies calls to `setRouteLeaveHook` to `props.transitionManager`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect3 = (0, _expect10.default)(transitionManager.listenBeforeLeavingRoute)).toHaveBeenCalledWith.apply(_expect3, args);
        (0, _expect10.default)(remove).toBe(listenBeforeLeavingRouteSentinel);
        done();
      });
    });
    ...
    it('proxies calls to `isActive` to `props.transitionManager`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect4 = (0, _expect10.default)(transitionManager.isActive)).toHaveBeenCalledWith.apply(_expect4, args);
        (0, _expect10.default)(isActive).toBe(isActiveSentinel);
        done();
      });
    });
    ...
    it('proxies calls to `createHref` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect5 = (0, _expect10.default)(history.createHref)).toHaveBeenCalledWith.apply(_expect5, args);
        (0, _expect10.default)(href).toBe(createHrefSentinel);
        done();
      });
    });
    ...
    it('proxies calls to `go` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect6 = (0, _expect10.default)(history.go)).toHaveBeenCalledWith.apply(_expect6, args);
        done();
      });
    });
    ...
    it('proxies calls to `goBack` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect7 = (0, _expect10.default)(history.goBack)).toHaveBeenCalledWith.apply(_expect7, args);
        done();
      });
    });
    ...
    it('proxies calls to `goForward` to `props.history`', function (done) {
      ...
      renderTest(function () {
        ...
        (_expect8 = (0, _expect10.default)(history.goForward)).toHaveBeenCalledWith.apply(_expect8, args);
        done();
      });
    });
  });
